    ...
    */
    ...
    return (
        <form className="gameForm">
            ...
            <fieldset>
                <div className="form-group">
                    <label htmlFor="skillLevel">Skill Level Required (1-5): </label>
                    <input type="number" name="skillLevel" required className="form-control" defaultValue={currentGame.skillLevel} onChange={handleControlledInputChange} min="1" max="5" step="1"
                    />
                </div>
            </fieldset>
            <fieldset>
